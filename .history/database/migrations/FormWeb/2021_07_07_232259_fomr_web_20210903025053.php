...
class FomrWeb extends Migration
{
    ...
    public function up()
    {
        Schema::create('formSolicitud', function (Blueprint $table) {
            ...
            $table->string('provSolicitud', 50)->nullable();
            $table->string('dptoSolicitud', 50)->nullable();
            $table->string('locSolicitud', 50)->nullable();
            $table->string('paraje', 50)->nullable();                      
        ...
        Schema::create('formEstadoSolicitud', function(Blueprint $table){
            ...
            $table->string('valor_estado')->nullable();
        });

        Schema::create('form_estado_solicitud_form_solicitud', function (Blueprint $table) {
            $table->bigIncrements('id');

            $table->unsignedBigInteger('form_estado_solicitud_id')->nullable();           
            $table->unsignedBigInteger('form_solicitud_id')->nullable();           

             $table->foreign('form_estado_solicitud_id')->references('id')->on('formEstadoSolicitud');
