...
class CreateProvinciasTable extends Migration
{
    ...
    public function up()
    {
        ...
        DB::statement('CREATE TABLE public."Provincia" (
        ...
        DB::statement('ALTER TABLE public."Provincia" OWNER TO postgres;');



        DB::statement('ALTER TABLE ONLY public."Provincia"
        ADD CONSTRAINT "Provincia_pkey" PRIMARY KEY (id);');


DB::statement('INSERT INTO public."Provincia"(
