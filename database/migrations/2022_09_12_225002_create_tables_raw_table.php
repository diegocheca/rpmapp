...
class CreateTablesRawTable extends Migration
{
    ...
    public function up()
    {
        DB::statement('CREATE TABLE public."Departamento2" (
        ...
        DB::statement('ALTER TABLE public."Departamento2" OWNER TO postgres;');



        DB::statement('ALTER TABLE ONLY public."Departamento2"
        ADD CONSTRAINT "Departamento2_pkey" PRIMARY KEY (id);');
