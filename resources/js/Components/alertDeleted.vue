        ...
        <div class="rounded-lg bg-red-300 text-white p-8 my-12 flex flex-col md:flex-row space-between items-center justify-between relative overflow-hidden">
            ...
            <div class="pt-8 md:pt-0 justify-center lg:ml-auto z-10">
                ...
                <a href="#" target="_blank" download
                    class="flex items-center px-8 py-4 text-center text-sm text-red-300 uppercase bg-white font-display rounded-full transition duration-200 hover:bg-red-600 hover:text-white">
                        <svg class="w-5 h-5 mr-3" width="20" height="24" viewBox="0 0 20 24" fill="none"
