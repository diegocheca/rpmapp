      ...
      <div class="items-center bg-teal-lighter">
        ...
        >
          ...
          >
            ...
            <div
              class="grid gap-4"
              :class="[col.columns, col.columnsResponsive]"
            >
              <!-- inputs -->
              <div
                      ...
                      >
                        ...
                        >
                          ...
                          <label
                            v-if="ele.label"
                            :for="ele.label"
                            class="mb-2 uppercase text-md text-grey-darkest"
                            >{{ ele.label }} :</label
                          >
...
export default {
  ...
  async mounted() {
    const module = await import(
      `../../../../helpers/formularios/${this.$props.province}`
    );
    ...
    this.yepSchema = this.formSchema.reduce(
      createYupSchema,
      {},
      this.$props.evaluate
    );
