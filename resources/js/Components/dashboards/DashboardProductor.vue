  ...
  <AppLayout>
    ...
    <main class="mx-auto p-4 md:w-3/4 px-4 py-4">
      ...
      >
        ...
        >
          ...
          <div class="flex-col my-auto">
            ...
            />
            <div class="">
              porcentaje de aprobación de la última inscripción
            </div>
          </div>
        </div>
        <div
          ...
          <p class="font-bold text-md p-4 text-black dark:text-white">
            ...
            >
              ...
              <div class="tab__header float-right text-indigo-600">
                <a
                  href="#"
                  @click.prevent="activeInscripcion = !activeInscripcion"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    class="h-5 w-5"
              ...
              <div
                class="tab__content p-2 bg-indigo-100 rounded-lg"
                v-show="activeInscripcion"
              >
                <slot />
                Puedes seleccionar cualquier inscripción para ver los datos de
                la misma
                <br />
                Referencias:
                <ul class="mt-2">
            ...
            <li v-for="(ins, index) in inscriptions" :key="index" class="">
              ...
              >
                <div class="flex items-center justify-start text-sm">
                  ...
                  <span> {{ ins.name }} {{ index + 1 }} </span>
                </div>
                <svg
                  v-if="ins.status == 'aprobado'"
                  width="20"
                  height="20"
                  fill="currentColor"
                  viewBox="0 0 1024 1024"
                ...
                <svg
                  v-if="ins.status == 'pendiente'"
                  width="20"
                  height="20"
                  xmlns="http://www.w3.org/2000/svg"
                  class="text-yellow-500 mx-4"
                  viewBox="0 0 20 20"
                  fill="currentColor"
                >
                  <path
          ...
          <p class="font-bold text-md p-4 text-black dark:text-white">
            ...
            >
              ...
              <div class="tab__header float-right text-indigo-600">
                <a
                  href="#"
                  @click.prevent="activeReinscripcion = !activeReinscripcion"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    class="h-5 w-5"
              ...
              <div
                class="tab__content p-2 bg-indigo-100 rounded-lg"
                v-show="activeReinscripcion"
              >
                <slot />
                Puedes seleccionar cualquier reinscripción para ver los datos de
                la misma
                <br />
                Referencias:
                <ul>
            ...
            <li v-for="(reins, index) in reinscriptions" :key="index" class="">
              ...
              >
                <div class="flex items-center justify-start text-sm">
                  ...
                  <span> {{ reins.name }} {{ index + 1 }} </span>
                </div>
                <svg
                  v-if="reins.status == 'aprobado'"
                  width="20"
                  height="20"
                  fill="currentColor"
                  viewBox="0 0 1024 1024"
      ...
      >
        ...
        <template #footer>
          <jet-button class="ml-2" @click="closeModal"> Entendido </jet-button>
        </template>
      </jet-dialog-modal>
    </main>
  </AppLayout>
