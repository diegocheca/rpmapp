<template>
  <app-layout class=" bg-gray-100">
                                ...
                                <td class="py-3 px-6 text-center">
                                    <div class="flex item-center justify-center">
                                        <div class="w-4 mr-2 transform hover:text-purple-500 hover:scale-110">
                                            <a v-if="hasAnyPermission(['reinscripciones.revision'])" :href="route('reinscripciones.revision', reinscripcion.id)">
                                        ...
                                        <div class="w-4 mr-2 transform hover:text-purple-500 hover:scale-110">
                                            ...
                                            <svg
                                                ...
                                                xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" @click="showModal(reinscripcion.id)"
                                            >
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" />
                                            </svg>
                                        </div>
    ...
    <jet-dialog-modal :show="modalConfirmDelete" :maxWidth="'md'"  @close="closeModal" >
        ...
        <template #footer>
            <jet-button class="ml-2" @click="deleteElement(true)">
                SI
            </jet-button>
        </template>
    </jet-dialog-modal>
