                        ...
                        <div class="col-sm-8 offset-sm-2 text-gray-50 text-center -mt-52">
                            <div class="relative ">
                              <h1 class="relative text-9xl tracking-tighter-less text-shadow font-sans font-bold">
                                <span>S</span><span>i</span><span>n</span></h1>
                                <h1 class="relative text-9xl tracking-tighter-less text-shadow font-sans font-bold">
                                <span>P</span><span>e</span><span>r</span><span>m</span><span>i</span><span>s</span><span>o</span><span>s</span></h1>
                                <span class="absolute  top-0   -ml-12  text-gray-300 font-semibold">Oops!</span>
                              </div>
                            <h5 class="text-gray-300 font-semibold -mr-10 -mt-3">Este Formulario no es suyo</h5>
                            <p class="text-gray-100 mt-2 mb-6">Disculpas, pero usted no puede acceder aca. Por favor, comuniquese con el administrador.</p>
                            <a
