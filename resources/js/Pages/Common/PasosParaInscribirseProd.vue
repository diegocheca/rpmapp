<template>
    <div>
        <h1 class="mb-4 text-center font-black text-gray-700">Pasos Para Inscribirse como Productor Minero</h1>
        <div class="flex">
            <div class="w-1/3 sm:w-1/1 md:w-1/2 text-center px-6">
                <div
                class="bg-blue-200 rounded-lg flex items-center justify-center border border-gray-200"
                >
                    <div
                    ...
                    >
                        <h2 class="font-bold text-sm">Completá el Formulario</h2>
                        <p class="text-xs text-gray-600">
                            Con información del productor que se está inscribiendo
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="w-1/3  sm:w-1/1 md:w-1/2 text-center px-6">
                <div
                class="bg-indigo-200 rounded-lg flex items-center justify-center border border-gray-200"
                >
                ...
                <div
                    class="w-2/3 bg-gray-200 h-24 flex flex-col items-center justify-center px-1 rounded-r-lg body-step"
                >
                    <h2 class="font-bold text-sm">Evaluación de Autoridades</h2>
                    <p class="text-xs text-gray-600">
                        La autoridad Minera evaluará esos datos
                    </p>
                </div>
                </div>
            </div>
            ...
            <div class="w-1/3  sm:w-1/1 md:w-1/2 text-center px-6">
                <div
                class="bg-red-200 rounded-lg flex items-center justify-center border border-gray-200"
                >
                <div class="w-1/3 bg-transparent h-20 flex items-center justify-center icon-step">
                ...
                <div
                    class="w-2/3 bg-gray-200 h-24 flex flex-col items-center justify-center px-1 rounded-r-lg body-step"
                >
                    <h2 class="font-bold text-sm">Formulario Con Errores</h2>
                    <p class="text-xs text-gray-600">
                        Si es necesario el productor corrige algunos errores
                    </p>
                </div>
                </div>
            </div>
            ...
            <div class="w-1/3  sm:w-1/1 md:w-1/2 text-center px-6">
                <div
                class="bg-green-200 rounded-lg flex items-center justify-center border border-gray-200"
                >
                <div class="w-1/3 bg-transparent h-20 flex items-center justify-center icon-step">
                ...
                <div
                    class="w-2/3 bg-gray-200 h-24 flex flex-col items-center justify-center px-1 rounded-r-lg body-step"
                >
                    <h2 class="font-bold text-sm">Formulario Aprobado</h2>
                    <p class="text-xs text-gray-600">
                    Será notificado vía email y podrá imprimir su credencial de Productor Minero
                    </p>
                </div>
                </div>
            </div>
