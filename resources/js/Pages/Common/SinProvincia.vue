<template>
    <app-layout>
        <body class="flex flex-col">
            <div class="flex items-center justify-center min-h-screen bg-blue-600  bg-fixed bg-cover bg-bottom error-bg"
                        ...
                        <div class="col-sm-8 offset-sm-2 text-gray-50 text-center -mt-52">
                            <div class="relative ">
                              <h1 class="relative text-9xl tracking-tighter-less text-shadow font-sans font-bold">
                                <span>S i n</span></h1>
                                <h1 class="relative text-9xl tracking-tighter-less text-shadow font-sans font-bold">
                                <span>P r o v i n c i a</span></h1>
                                <!-- <span class="absolute  top-0   -ml-12  text-gray-300 font-semibold">Oops!</span> -->
                              </div>
                            <p class="text-gray-100 mt-2 mb-6">Disculpas, pero usted pertence a una provincia que aun no ha sido implementada. Por favor, comuniquese con el administrador.</p>
                            <a
                              :href="route('dashboard')"
                              class="bg-green-400 hover:bg-green-700 px-10 py-5 text shadow-sm font-medium tracking-wider text-gray-50 hover:shadow-lg">
                              Volver
                            </a>
                        </div>
                    </div>
