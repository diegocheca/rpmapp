           ...
           <!-- <div class="flex h-screen bg-gray-200 items-center justify-center  mt-32 mb-32"> -->
            <!-- <div class="grid bg-white rounded-lg shadow-xl w-11/12 md:w-9/12 lg:w-1/2"> -->
              ...
              <div class="flex justify-center">
                <div class="flex">
                  <h1 class="text-gray-600 font-bold md:text-2xl text-xl">Creando IIA o DIA</h1>
                </div>
              </div>
...
export default {
  ...
  data() {
    return {
      form: {
        fecha_notificacion_dia: null,
        fecha_vencimiento: null,
        actividades: null,
        acciones_a_desarrollar: null,
        archivo_dia: null,
        constancia_inscripcion_ia: null,
        created_by: null,
        estado: null,
      },
    };
  ...
  methods: {
    submit() {
      this.$inertia.post(route('iiadias.store'), this.form);
    },
  },
};
</script>