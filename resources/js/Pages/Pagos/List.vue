<template>
  <app-layout>
    ...
    >
      Pagos de Canon Mineros Ya cargados
    </h2>
    ...
    <body class="flex flex-col">
      <div class="-my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
        <div class="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
          ...
          >
           <a :href="route('pagos.create')"> <button class="px-9 py-4   mb-4  text-base   font-semibold rounded-full block  border-b border-purple-300 bg-purple-200 hover:bg-purple-300 text-purple-700">Nuevo Pago</button></a>
                ...
                <tr v-for="pago in pagos" :key="pago.id">
                  ...
                  >
                    <inertia-link
                      ...
                      :href="route('productors.edit', pago.id)"
                  ...
                  >
                    <inertia-link
                      method="delete"
                      :href="route('productors.destroy', pago.id)"
