<template>
  <AppLayout>
    ...
    <main class="bg-gray-100 rounded-2xl relative relative">
      <div class="flex items-start justify-between">
        <div class="h-screen hidden lg:block my-4 ml-4 shadow-lg relative w-80">
          <div class="bg-white h-full rounded-2xl">
            ...
            >
              ...
              >
                ...
                <img
                  class="relative w-40"
                  :src="
                    $inertia.page.props.appName + '/minerales/thumbs/1171.png'
                  "
                  alt=""
                />
              </div>
            ...
            >
              ...
              >
                ...
                <img
                  class="relative w-40"
                  :src="
                    $inertia.page.props.appName + '/minerales/thumbs/1132.png'
                  "
                  alt=""
                />
              </div>
            ...
            >
              ...
              >
                ...
                <img
                  class="relative w-40"
                  :src="
                    $inertia.page.props.appName + '/minerales/thumbs/1104.png'
                  "
                  alt=""
                />
              </div>
            ...
            <!-- <nav class="mt-6">
                    <div>
                        <a class="w-full font-thin uppercase text-blue-500 flex items-center p-4 my-2 transition-colors duration-200 justify-start bg-gradient-to-r from-white to-blue-100 border-r-4 border-blue-500   border-r-4 border-blue-500" href="#">
                        ...
                        <a class="w-full font-thin uppercase text-gray-500   flex items-center p-4 my-2 transition-colors duration-200 justify-start hover:text-blue-500" href="#">
                            <span class="text-left">
        ...
        <div class="flex flex-col w-full pl-0 md:p-4 md:space-y-4">
          <header
            class="w-full shadow-lg bg-white items-center rounded-2xl z-40"
          >
            <div class="flex p-6 sm:px-20 bg-white border-b border-gray-200">
              ...
              <div class="flex-auto">
                ...
                for your next Laravel application. Laravel is designed ecosystem
                to be a breath of fresh air. We hope you love it.
              </div>
            </div>
          </header>
          <header
            class="w-full shadow-lg bg-white items-center h-16 rounded-2xl z-40"
          >
            <div
              class="
                relative
                    ...
                    <div class="block m-auto">
                      <div>
                        <span class="text-sm inline-block text-gray-500">
                          Task done :
                          <span class="text-gray-700 font-bold"> 25 </span>
                          /50
                        </span>
                      </div>
                  ...
                  <div class="shadow-lg rounded-2xl p-4 bg-white w-full">
                    ...
                    <div class="block m-auto">
                      <div>
                        <span class="text-sm inline-block text-gray-500">
                          Task done :
                          <span class="text-gray-700 font-bold"> 50 </span>
                          /50
                        </span>
                      </div>
                      <div class="w-full h-2 bg-gray-200 rounded-full mt-2">
                ...
                <div class="mb-4 mx-0 sm:ml-4 xl:mr-4">
                  <div class="shadow-lg rounded-2xl bg-white w-full">
                    <p class="font-bold text-md p-4 text-black">
                      My Tasks
                      <span class="text-sm text-gray-500 ml-2"> (05) </span>
                    </p>
                    <ul>
                      <li
                        class="
                      ...
                      >
                        <div class="flex items-center justify-start text-sm">
                          ...
                          <span
                            class="lg:ml-6 ml-2 flex items-center text-gray-400"
                          >
                            3
                            <svg
                              width="15"
                ...
                <div class="mb-4 sm:ml-4 xl:mr-4">
                  <div class="shadow-lg rounded-2xl bg-white w-full">
                    <div class="flex items-center p-4 justify-between">
                      <p class="font-bold text-md text-black">Google</p>
                      <button
                        class="
                          text-sm
                          p-1
                    ...
                    <div
                      ...
                      "
                    >
                      <p class="font-bold text-md text-black">Slack</p>
                      <button
                        class="
                          text-sm
                          p-1
