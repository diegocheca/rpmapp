                    ...
                    <div class="w-full lg:w-5/6">
                        <div class="bg-white shadow-md rounded my-6">
                            <div v-if="mostrar_alert_eliminar" class="alert flex flex-row items-center bg-red-200 p-5 rounded border-b-2 border-red-300">
                                ...
                                <div class="alert-content ml-4">
                                    ...
                                    <div class="alert-description text-sm text-red-600">
                                        Se elmino correctamente el formulario con id: {{id_a_eliminar}}
                                    </div>
                                    ...
                                    <tr v-for="productor in borradores" :key="productor.id">
                                        ...
                                        <td class="py-3 px-6 text-center">
                                            <div class="flex item-center justify-center">
                                                ...
                                                <div v-if= "mostrar_borrar(productor.estado)" class="w-4 mr-2 transform hover:text-purple-500 hover:scale-110">
                            ...
                            <jet-dialog-modal :show="mostrarModal" @close="closeModal">
                                ...
                                <template #footer>
                                    <div class="flex">
                                        <button class="w-1/5 flex items-center justify-center " @click="closeModal">
                                                Cancelar
                                        </button>
                                        <button @click="eliminarRegistro" class="w-1/5 p-2 my-2 bg-red-500 text-white rounded-md focus:outline-none focus:ring-2 ring-red-300 ring-offset-2 flex items-center justify-center ">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" />
                                            </svg>
                                            Si, eliminar
    ...
    methods:{
        mostrar_editar(estado){
            if(this.$props.soy_productor === true || this.$props.soy_productor === 'true')
            {
                ...
                if(this.$props.soy_autoridad === true || this.$props.soy_autoridad === 'true')
                {
                    if(estado=== 'en proceso')
                        return true;
                    if(estado=== 'borrador')
        ...
        eliminarRegistro(){
            let self  = this;
            axios.delete('/formularios/eliminar_formulario'+'/'+this.id_a_eliminar)
