    ...
    <div class="overflow-x-auto">
      ...
      >
        ...
        >
          ...
          <p class="text-2xl">No se han registrado Borradores</p>
        </div>
        <div v-if="borradores.data.length > 0" class="w-full lg:w-5/6">
                ...
                >
                  ...
                  <td class="py-3 px-6 text-center">
                    <div class="flex item-center justify-center">
                      ...
                      >
                        <a
                          :href="route('comprobante_inicio', productor.id)"
                          target="_blank"
                        >
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
