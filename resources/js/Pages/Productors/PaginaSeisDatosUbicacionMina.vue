    ...
    <!-- <div class="flex justify-end md:justify-end -mt-16 sticky top-0 z-10">
      <a href="#section_datos_mina_ubicacion">
        <img
          ...
          "
          :src="
            $inertia.page.props.appName + '/slick/img/features/plano-minero.svg'
          "
        />
      </a>
      ...
      <div class="flex">
        <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
          <SelectProvincia
            ...
            v-bind:leal_provincia_valido="
              $props.localidad_mina_provincia_validacion
            "
            v-bind:leal_provincia_correcto="
            ...
            v-bind:mostrar_legal_prov_correccion="
              $props.mostrar_ubicacion_prov_correccion
            "
          ...
          <div class="flex" v-if="mostrar_testing">
            -- localidad_mina_provincia deel padre{{
              form_pagina.localidad_mina_provincia
            }}
            ...
            -- obs_localidad_mina_provincia observacion deel padre{{
              form_pagina.obs_localidad_mina_provincia
            }}
            -- obs_localidad_mina_provincia_valido observacion valida deel
        ...
        <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
          ...
          <div class="flex" v-if="mostrar_testing">
            -- dpto _mina_provincia deel padre{{
              form_pagina.localidad_mina_departamento
            }}
            -- dpto _mina_provincia_validacion valida deel padre{{
              form_pagina.localidad_mina_departamento_validacion
            }}
            -- dpto _mina_provincia_correcto correcto deel padre{{
              form_pagina.localidad_mina_departamento_correcto
            }}
            -- obs_dpto_provincia observacion deel padre{{
              form_pagina.obs_localidad_mina_departamento
            }}
            -- obs_dpto_provincia_valido observacion valida deel padre{{
      ...
      <div class="flex">
        <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
          <NombreMina
            ...
            v-bind:mostrar_correccion="
              $props.mostrar_ubicacion_localidad_correccion
            "
          ...
          <div class="flex" v-if="mostrar_testing">
            <br />
            localidad_mina_localidad de Mina valor padre:
            {{ form_pagina.localidad_mina_localidad }} <br />
            localidad_mina_localidad_validacion de Mina valido del padre:
            {{ form_pagina.localidad_mina_localidad_validacion }} <br />
            localidad_mina_localidad_correcto de Mina correcto deel padre:
            {{ form_pagina.localidad_mina_localidad_correcto }} <br />
            obs_localidad_mina_localidad de Mina observacion deel padre:
            {{ form_pagina.obs_localidad_mina_localidad }} <br />
            obs_localidad_mina_localidad_valido de Mina observacion valida deel
        ...
        <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
          <TipoDeSistemaGeo
            ...
            v-bind:mostrar_correccion="
              $props.mostrar_ubicacion_sistema_correccion
            "
            v-bind:desactivar_correccion="
          ...
          <div class="flex" v-if="mostrar_testing">
            <br />
            tipo_sistema de Mina valor padre: {{ form_pagina.tipo_sistema }}
            <br />
            tipo_sistema_validacion de Mina valido del padre:
            {{ form_pagina.tipo_sistema_validacion }} <br />
            tipo_sistema_correcto de Mina correcto deel padre:
            {{ form_pagina.tipo_sistema_correcto }} <br />
            obs_tipo_sistema de Mina observacion deel padre:
            {{ form_pagina.obs_tipo_sistema }} <br />
            obs_tipo_sistema_valido de Mina observacion valida deel padre:
      ...
      <div class="flex">
        <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
          <NombreMina
            ...
            v-bind:mostrar_correccion="
              $props.mostrar_ubicacion_latitud_correccion
            "
            v-bind:desactivar_correccion="
          ...
          <div class="flex" v-if="mostrar_testing">
            <br />
            latitud de Mina valor padre: {{ form_pagina.latitud }} <br />
            latitud_validacion de Mina valido del padre:
            {{ form_pagina.latitud_validacion }} <br />
            latitud_correcto de Mina correcto deel padre:
            {{ form_pagina.latitud_correcto }} <br />
            obs_latitud de Mina observacion deel padre:
            {{ form_pagina.obs_latitud }} <br />
            obs_latitud_valido de Mina observacion valida deel padre:
        ...
        <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
          ...
          <div class="flex" v-if="mostrar_testing">
            <br />
            longitud de Mina valor padre: {{ form_pagina.longitud }} <br />
            longitud_validacion de Mina valido del padre:
            {{ form_pagina.longitud_validacion }} <br />
            longitud_correcto de Mina correcto deel padre:
            {{ form_pagina.longitud_correcto }} <br />
            obs_longitud de Mina observacion deel padre:
            {{ form_pagina.obs_longitud }} <br />
            obs_longitud_valido de Mina observacion valida deel padre:
            {{ form_pagina.obs_longitud_valido }}
          </div>
        </div>
      </div>
    </div>
