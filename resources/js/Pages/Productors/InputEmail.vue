        ...
        <div class="mt-2">
          <label class="inline-flex items-center">
            <input
              ...
              name="name_email_correcto"
              v-model="email_correcto"
              value="true"
              v-on:change="actaulizar_variable_email(true)"
            />
          ...
          <label class="inline-flex items-center ml-6">
            <input
              ...
              v-model="email_correcto"
              value="false"
              v-on:change="actaulizar_variable_email(false)"
            />
          ...
          <label class="inline-flex items-center ml-6">
            <input
              ...
              v-model="email_correcto"
              value="nada"
              v-on:change="actaulizar_variable_email('nada')"
            />
