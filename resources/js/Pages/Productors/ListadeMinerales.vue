                    ...
                    <div class="flex flex-col" v-for="(mineral, index) in minerales" v-bind:key="mineral.id">
                        <div class="bg-white shadow-md  rounded-3xl p-4">
                            <div class="flex-none lg:flex">
                                ...
                                <div class="flex-auto ml-3 justify-evenly py-2 sm:col-1">
                                    <div class="flex flex-wrap ">
                                    ...
                                    <div class="flex flex-wrap py-4  sm:w-full text-sm text-gray-600">
                                        <div class="flex-1 sm:w-full inline-flex items-center">
                                        ...
                                        <div class="flex flex-col sm:w-full inline-flex items-center">
                                            <div class="flex-1 sm:w-full inline-flex items-center">
                                                <label
                                                    class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2"
                                                    for="observaciones"
                                            ...
                                            <div class="flex-1 sm:w-full sm:h-32 inline-flex items-center">
                                                <textarea
                                                    :disabled="$props.evaluacion || $props.desactivar_input"
...
export default {
  ...
  data() {
    return {
        ...
        clase_text_area_presentacion: 'appearance-none block w-full sm:h-32 bg-gray-200 text-gray-700 border rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white',
