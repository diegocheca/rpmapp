      ...
      <div class="flex flex-wrap mb-4">
        ...
        >
          ...
          <div v-show="ayuda_local">
            ...
            >
              <p class="p-3">
                Hace referencia a si usted es el propietario de la manifestación
        ...
        >
          <CaracterQueInvoca
            ...
            v-bind:mostrar_owner_correccion="
              $props.mostrar_arrendatario_correccion
            "
            v-bind:desactivar_owner_correccion="
          ...
          <div v-show="ayuda_local">
            ...
            >
              <p class="p-3">
                Hace referencia a si usted es arendatario de la manifestación
                que se esta declarando.
              </p>
            </div>
            <br />
        ...
        >
          <SubirArchivo
            ...
            v-bind:mostrar_correccion="
              $props.mostrar_contancias_canon_correccion
            "
          ...
          <div v-show="ayuda_local">
            ...
            >
              <p class="p-3">
                Aquí debe colocar un archivo donde quede constancia del pago del
                canon minero asociado a la manifestación que esta declarando.
              </p>
            </div>
            <br />
          </div>
      ...
      <div class="flex">
        <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
          <FechaGenerica
            ...
            v-bind:valor_input_validacion="
              form_pagina.fecha_alta_dia_validacion
            "
        ...
        <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
          <FechaGenerica
            ...
            v-bind:mostrar_correccion="
              $props.mostrar_fecha_vencimiento_dia_correccion
            "
            v-bind:desactivar_correccion="
...
export default {
  ...
  methods: {
    ...
    enviar_constancia() {
      ...
      axios
        .post(
          $inertia.page.props.appName + "/formularios/auto_guardado_cinco",
          data
        )
