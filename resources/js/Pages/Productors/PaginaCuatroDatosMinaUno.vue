      ...
      <div class="flex flex-wrap">
        ...
        <div class="w-full sm:w-2/2 md:w-1/2 px-3 mb-2 md:mb-2">
          ...
          <div v-show="ayuda_local">
            ...
            >
              <p class="p-3">
                Es el número de expediente con el cual se ha tramitado el
                expediente.
              </p>
            </div>
            <br />
        ...
        <div class="w-full sm:w-2/2 md:w-1/2 px-3">
          ...
          <div v-show="ayuda_local">
            ...
            >
              <p class="p-3">
                Es el distrito minero asignado en el expediente con el cual se
      ...
      <div class="flex flex-wrap">
        ...
        <div class="w-full sm:w-2/2 md:w-1/2 px-3">
          ...
          <div v-show="ayuda_local">
            ...
            >
              <p class="p-3">
                Debe seleccionar la opción que usted está registrando, ya sea
                mina o cantera.
              </p>
            </div>
            <br />
      ...
      <div v-if="form_pagina.categoria" class="flex flex-wrap">
        <div class="w-full md:w-2/2 px-3 mb-2 md:mb-2">
          <SubirArchivo
            v-if="
              form_pagina.categoria !== 'tercera' &&
              $props.mostrar_resolucion_concesion
            "
            ...
            v-bind:mostrar_correccion="
              $props.mostrar_resolucion_concesion_correccion
            "
            v-bind:desactivar_correccion="
      ...
      <div class="flex flex-wrap">
        <div v-if="form_pagina.categoria" class="w-full md:w-2/2 px-3 mb-2 md:mb-2">
          <ListadeMinerales
            ...
            v-bind:lista_de_minerales_pre_cargados="
              $props.lista_minerales_desde_back
            "
          ...
          <div v-show="ayuda_local">
            ...
            >
              <p class="p-3">
                Debe completar la lista de minerales con aquellos minerales que
                justamente serán explotados en este yacimiento.
              </p>
            </div>
            <br />
          </div>
...
export default {
  ...
  methods: {
    ...
    update_valor_cat(newValue) {
      ...
      //alert("cambie la categoria de:"+newValue);
      if (newValue === "primera") self.form_pagina.mina_cantera = "Mina";
      if (newValue === "segunda") self.form_pagina.mina_cantera = "Mina";
      if (newValue === "tercera") self.form_pagina.mina_cantera = "Cantera";

      axios
        .post("/datos/traer_minerales/", { categoria_buscando: newValue })
  ...
  mounted() {
    ...
    if (this.$props.categoria !== null && this.$props.categoria !== "") {
      ...
      this.$nextTick(() => {
        axios
          .post("/datos/traer_minerales", {
            categoria_buscando: this.$props.categoria,
          })
          .then(function (response) {
      ...
      self.lista_de_minerales = [{ id: 0, name: "vacio", categoria: "null" }];
    }
  },
};
</script>