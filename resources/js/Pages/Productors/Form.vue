      ...
      <div class="w-full bg-white rounded shadow-lg p-8 m-4">
        ...
        <form @submit.prevent="submit" class="mb-8">
            ...
            <a href="#inicio">
              <div class="flex items-center absolute shadow-xl left-8 top-10">
                <svg
                  ...
                  height="16"
                  fill="currentColor"
                  class="animate-bounce bi bi-arrow-up"
                  viewBox="0 0 16 16"
                >
                  <path
                    fill-rule="evenodd"
          ...
          <PaginaUnoDatosProductores
            ...
            :mostrar_razon_social="mostrar1.razon_social"
            :desactivar_razon_social="disables1.razon_social"
            :mostrar_razon_social_correccion="
              mostrar1.razon_social_correccion
            "
            :desactivar_razon_social_correccion="
              disables1.razon_social_correccion
            "
            :email="form.email"
            ...
            :mostrar_email="mostrar1.email"
            :desactivar_email="disables1.email"
            :mostrar_email_correccion="mostrar1.email_correccion"
            :desactivar_email_correccion="disables1.email_correccion"
            :cuit="form.cuit"
            :cuit_valido="form.cuit_valido"
            :cuit_correcto="form.cuit_correcto"
            :obs_cuit="form.obs_cuit"
            :obs_cuit_valido="form.obs_cuit_valido"
            :mostrar_cuit="mostrar1.cuit"
            :desactivar_cuit="disables1.cuit"
            :mostrar_cuit_correccion="mostrar1.cuit_correccion"
            :desactivar_cuit_correccion="disables1.cuit_correccion"
            ...
            :mostrar_num_prod="mostrar1.num_prod"
            :desactivar_num_prod="disables1.num_prod"
            :mostrar_num_prod_correccion="mostrar1.num_prod_correccion"
            :desactivar_num_prod_correccion="
              disables1.num_prod_correccion
            "
            ...
            :mostrar_tipo_sociedad="mostrar1.tipo_sociedad"
            :desactivar_tipo_sociedad="disables1.tipo_sociedad"
            :mostrar_tipo_sociedad_correccion="
              mostrar1.num_prod_correccion
            "
            ...
            :mostrar_inscripcion_dgr="mostrar1.inscripcion_dgr"
            :desactivar_inscripcion_dgr="disables1.inscripcion_dgr"
            :mostrar_inscripcion_dgr_correccion="
              mostrar1.inscripcion_dgr_correccion
            "
            :desactivar_inscripcion_dgr_correccion="
              disables1.inscripcion_dgr_correccion
            "
            ...
            :mostrar_constancia_sociedad="mostrar1.constancia_sociedad"
            :desactivar_constancia_sociedad="
              disables1.constancia_sociedad
            "
            :mostrar_constancia_sociedad_correccion="
              mostrar1.cosntancia_sociedad_correccion
            "
            :desactivar_constancia_sociedad_correccion="
              disables1.cosntancia_sociedad_correccion
            "
            :mostrar_boton_guardar_uno="mostrar1.boton_guardar_uno"
            :desactivar_boton_guardar_uno="disables1.boton_guardar_uno"
            :evaluacion="evaluacion_global"
            :testing="testing_global"
            :id="form.id"
            v-on:ChangeRazonSocialEvaluacion="
              update_razon_social_evaluacion($event)
            "
            ...
            v-on:ChangeTipoSociedadEvaluacion="
              update_tipo_sociedad_evaluacion($event)
            "
            v-on:ChangeInscripcionDGREvaluacion="
              update_inscripcion_dgr_evaluacion($event)
            "
            v-on:ChangeConstanciaSociedadEvaluacion="
              update_constancia_sociedad_evaluacion($event)
            "
          ...
          <PaginaDosDatosDomLegal
            ...
            :mostrar_calle_legal="mostrar1.legal_calle"
            :desactivar_calle_legal="disables1.legal_calle"
            :mostrar_calle_legal_correccion="
              mostrar1.legal_calle_correccion
            "
            :desactivar_calle_legal_correccion="
              disables1.legal_calle_correccion
            "
            ...
            :mostrar_legal_calle_num="mostrar1.legal_calle_num"
            :desactivar_legal_calle_num="disables1.legal_calle_num"
            :mostrar_legal_calle_num_correccion="
              mostrar1.legal_calle_num_correccion
            "
            :desactivar_legal_calle_num_correccion="
              disables1.legal_calle_num_correccion
            "
            ...
            :mostrar_legal_telefono="mostrar1.legal_telefono"
            :desactivar_legal_telefono="disables1.legal_telefono"
            :mostrar_legal_telefono_correccion="
              mostrar1.legal_telefono_correccion
            "
            :desactivar_legal_telefono_correccion="
              disables1.legal_telefono_correccion
            "
            ...
            :mostrar_legal_prov="mostrar1.legal_prov"
            :desactivar_legal_prov="disables1.legal_prov"
            :mostrar_legal_prov_correccion="
              mostrar1.legal_prov_correccion
            "
            :desactivar_legal_prov_correccion="
              disables1.legal_prov_correccion
            "
            ...
            :mostrar_legal_dpto="mostrar1.legal_dpto"
            :desactivar_legal_dpto="disables1.legal_dpto"
            :mostrar_legal_dpto_correccion="
              mostrar1.legal_dpto_correccion
            "
            :desactivar_legal_dpto_correccion="
              disables1.legal_dpto_correccion
            "
            ...
            :mostrar_legal_localidad="mostrar1.legal_localidad"
            :desactivar_legal_localidad="disables1.legal_localidad"
            :mostrar_legal_localidad_correccion="
              mostrar1.legal_localidad_correccion
            "
            :desactivar_legal_localidad_correccion="
              disables1.legal_localidad_correccion
            "
            ...
            :mostrar_legal_cod_pos="mostrar1.legal_cod_pos"
            :desactivar_legal_cod_pos="disables1.legal_cod_pos"
            :mostrar_legal_cod_pos_correccion="
              mostrar1.legal_cod_pos_correccion
            "
            :desactivar_legal_cod_pos_correccion="
              disables1.legal_cod_pos_correccion
            "
            ...
            :mostrar_legal_otro="mostrar1.legal_otro"
            :desactivar_legal_otro="disables1.legal_otro"
            :mostrar_legal_otro_correccion="
              mostrar1.legal_otro_correccion
            "
            :desactivar_legal_otro_correccion="
              disables1.legal_otro_correccion
            "
            :donde_estoy="'legal'"
            :lista_provincias="lista_provincias"
            :lista_dptos="lista_dptos_legal"
            :mostrar_boton_guardar_dos="mostrar1.boton_guardar_dos"
            :desactivar_boton_guardar_dos="disables1.boton_guardar_dos"
            :evaluacion="evaluacion_global"
            :testing="testing_global"
            :id="form.id"
          >
          ...
          <PaginaDosDatosDomLegal
            ...
            :obs_nombre_calle_legal_valido="
              form.obs_administracion_calle_nombre_valido
            "
            :mostrar_calle_legal="mostrar1.administracion_calle"
            :desactivar_calle_legal="disables1.administracion_calle"
            :mostrar_calle_legal_correccion="
              mostrar1.administracion_correccion
            "
            :desactivar_calle_legal_correccion="
              disables1.administracion_correccion
            "
            ...
            :obs_leal_numero_valido="
              form.obs_administracion_numero_nombre_valido
            "
            :mostrar_legal_calle_num="mostrar1.administracion_calle_num"
            :desactivar_legal_calle_num="
              disables1.administracion_calle_num
            "
            :mostrar_legal_calle_num_correccion="
              mostrar1.administracion_calle_num_correccion
            "
            :desactivar_legal_calle_num_correccion="
              disables1.administracion_calle_num_correccion
            "
            ...
            :obs_leal_telefono_valido="
              form.obs_administracion_telefono_nombre_valido
            "
            :mostrar_legal_telefono="mostrar1.administracion_telefono"
            :desactivar_legal_telefono="disables1.administracion_telefono"
            :mostrar_legal_telefono_correccion="
              mostrar1.legal_telefono_correccion
            "
            :desactivar_legal_telefono_correccion="
              disables1.administracion_telefono_correccion
            "
            ...
            :obs_leal_provincia_valido="
              form.obs_administracion_provincia_valido
            "
            :mostrar_legal_prov="mostrar1.administracion_prov"
            :desactivar_legal_prov="disables1.administracion_prov"
            :mostrar_legal_prov_correccion="
              mostrar1.administracion_prov_correccion
            "
            :desactivar_legal_prov_correccion="
              disables1.administracion_prov_correccion
            "
            ...
            :leal_departamento_correcto="
              form.administracion_departamento_correcto
            "
            :obs_leal_departamento="form.obs_administracion_departamento"
            :obs_leal_departamento_valido="
              form.obs_administracion_departamento_valido
            "
            :mostrar_legal_dpto="mostrar1.administracion_dpto"
            :desactivar_legal_dpto="disables1.administracion_dpto"
            :mostrar_legal_dpto_correccion="
              mostrar1.administracion_dpto_correccion
            "
            :desactivar_legal_dpto_correccion="
              disables1.administracion_dpto_correccion
            "
            ...
            :obs_leal_localidad_valido="
              form.obs_administracion_localidad_valido
            "
            :mostrar_legal_localidad="mostrar1.administracion_localidad"
            :desactivar_legal_localidad="
              disables1.administracion_localidad
            "
            :mostrar_legal_localidad_correccion="
              mostrar1.administracion_localidad_correccion
            "
            :desactivar_legal_localidad_correccion="
              disables1.administracion_localidad_correccion
            "
            ...
            :mostrar_legal_cod_pos="mostrar1.administracion_cod_pos"
            :desactivar_legal_cod_pos="disables1.administracion_cod_pos"
            :mostrar_legal_cod_pos_correccion="
              mostrar1.administracion_cod_pos_correccion
            "
            :desactivar_legal_cod_pos_correccion="
              disables1.administracion_cod_pos_correccion
            "
            ...
            :mostrar_legal_otro="mostrar1.administracion_otro"
            :desactivar_legal_otro="disables1.administracion_otro"
            :mostrar_legal_otro_correccion="
              mostrar1.administracion_otro_correccion
            "
            :desactivar_legal_otro_correccion="
              disables1.administracion_otro_correccion
            "
            :donde_estoy="'administrativo'"
            :lista_provincias="lista_provincias"
            :lista_dptos="lista_dptos_admin"
            :mostrar_boton_guardar_dos="mostrar1.boton_guardar_tres"
            :desactivar_boton_guardar_dos="disables1.boton_guardar_tres"
            :evaluacion="evaluacion_global"
            :testing="testing_global"
            :id="form.id"
          >
          ...
          <PaginaCuatroDatosMinaUno
            ...
            :mostrar_num_exp="mostrar1.num_exp"
            :desactivar_num_exp="disables1.num_exp"
            :mostrar_num_exp_correccion="mostrar1.num_exp_correccion"
            :desactivar_num_exp_correccion="disables1.num_exp_correccion"
            ...
            :mostrar_categoria="mostrar1.categoria"
            :desactivar_categoria="disables1.categoria"
            :mostrar_categoria_correccion="mostrar1.categoria_correccion"
            :desactivar_categoria_correccion="
              disables1.categoria_correccion
            "
            ...
            :mostrar_nombre_mina="mostrar1.nombre_mina"
            :desactivar_nombre_mina="disables1.nombre_mina"
            :mostrar_nombre_mina_correccion="
              mostrar1.nombre_mina_correccion
            "
            :desactivar_nombre_mina_correccion="
              disables1.nombre_mina_correccion
            "
            ...
            :mostrar_descripcion_mina="mostrar1.descripcion_mina"
            :desactivar_descripcion_mina="disables1.descripcion_mina"
            :mostrar_descripcion_mina_correccion="
              mostrar1.descripcion_correccion
            "
            :desactivar_descripcion_mina_correccion="
              disables1.descripcion_correccion
            "
            ...
            :mostrar_distrito="mostrar1.distrito"
            :desactivar_distrito="disables1.distrito"
            :mostrar_distrito_correccion="mostrar1.distrito_correccion"
            :desactivar_distrito_correccion="
              disables1.distrito_correccion
            "
            ...
            :mostrar_plano_mina="mostrar1.plano_mina"
            :desactivar_plano_mina="disables1.plano_mina"
            :mostrar_plano_mina_correccion="
              mostrar1.plano_mina_correccion
            "
            :desactivar_plano_mina_correccion="
              disables1.plano_mina_correccion
            "
            ...
            :mostrar_minerales="mostrar1.minerales"
            :desactivar_minerales="disables1.minerales"
            :mostrar_minerales_correccion="mostrar1.minerales_correccion"
            :desactivar_minerales_correccion="
              disables1.minerales_correccion
            "
            :resolucion_concesion_minera="form.resolucion_concesion_minera"
            :resolucion_concesion_minera_validacion="
              form.resolucion_concesion_minera_validacion
            "
            :resolucion_concesion_minera_correcto="
              form.resolucion_concesion_minera_correcto
            "
            :obs_resolucion_concesion_minera="
              form.obs_resolucion_concesion_minera
            "
            :obs_resolucion_concesion_minera_valido="
              form.obs_resolucion_concesion_minera_valido
            "
            :mostrar_resolucion_concesion="mostrar1.resolucion_concesion"
            :desactivar_resolucion_concesion="
              disables1.resolucion_concesion
            "
            :mostrar_resolucion_concesion_correccion="
              mostrar1.resolucion_concesion_correccion
            "
            :desactivar_resolucion_concesion_correccion="
              disables1.resolucion_concesion_correccion
            "
            :titulo_contrato_posecion="form.titulo_contrato_posecion"
            :titulo_contrato_posecion_validacion="
              form.titulo_contrato_posecion_validacion
            "
            :titulo_contrato_posecion_correcto="
              form.titulo_contrato_posecion_correcto
            "
            :obs_titulo_contrato_posecion="form.obs_titulo_contrato_posecion"
            :obs_titulo_contrato_posecion_valido="
              form.obs_titulo_contrato_posecion_valido
            "
            :mostrar_titulo="mostrar1.titulo"
            :desactivar_titulo="disables1.titulo"
            :mostrar_titulo_correccion="mostrar1.titulo_correccion"
            :desactivar_titulo_correccion="disables1.titulo_correccion"
            :lista_minerales_desde_back="lista_de_minerales_del_back"
            :mostrar_boton_guardar_cuatro="mostrar1.boton_guardar_cuatro"
            :desactivar_boton_guardar_cuatro="
              disables1.boton_guardar_cuatro
            "
            :evaluacion="evaluacion_global"
            :id="form.id"
            :testing="testing_global"
          ...
          <PaginaCincoDatosMinaDos
            ...
            :mostrar_owner="mostrar1.owner"
            :desactivar_owner="disables1.owner"
            :mostrar_owner_correccion="mostrar1.owner_correccion"
            :desactivar_owner_correccion="disables1.owner_correccion"
            ...
            :mostrar_arrendatario="mostrar1.concesionario"
            :desactivar_arrendatario="disables1.concesionario"
            :mostrar_arrendatario_correccion="
              mostrar1.concesionario_correccion
            "
            :desactivar_arrendatario_correccion="
              disables1.concesionario_correccion
            "
            ...
            :mostrar_concesionario="mostrar1.arrendatario"
            :desactivar_concesionario="disables1.arrendatario"
            :mostrar_concesionario_correccion="
              mostrar1.arrendatario_correccion
            "
            :desactivar_concesionario_correccion="
              disables1.arrendatario_correccion
            "
            :otros="form.otros"
            ...
            :mostrar_otros="mostrar1.otros"
            :desactivar_otros="disables1.otros"
            :mostrar_otros_correccion="mostrar1.otros_correccion"
            :desactivar_otros_correccion="disables1.otros_correccion"
            ...
            :mostrar_sustancias="mostrar1.sustancias"
            :desactivar_sustancias="disables1.sustancias"
            :mostrar_sustancias_correccion="
              mostrar1.sustancias_correccion
            "
            :desactivar_sustancias_correccion="
              disables1.sustancias_correccion
            "
            :titulo_contrato_posecion="form.titulo_contrato_posecion"
            :titulo_contrato_posecion_validacion="
              form.titulo_contrato_posecion_validacion
            ...
            :obs_resolucion_concesion_minera_valido="
              form.obs_resolucion_concesion_minera_valido
            "
            :mostrar_concesion="mostrar1.concesion"
            :desactivar_concesion="disables1.concesion"
            :mostrar_concesion_correccion="mostrar1.concesion_correccion"
            :desactivar_concesion_correccion="
              disables1.concesion_correccion
            "
            :constancia_pago_canon="form.constancia_pago_canon"
            :constancia_pago_canon_validacion="
              form.constancia_pago_canon_validacion
            "
            :constancia_pago_canon_correcto="
              form.constancia_pago_canon_correcto
            "
            :obs_constancia_pago_canon="form.obs_constancia_pago_canon"
            :obs_constancia_pago_canon_valido="
              form.obs_constancia_pago_canon_valido
            "
            :mostrar_contancias_canon="mostrar1.contancias_canon"
            :desactivar_contancias_canon="disables1.contancias_canon"
            :mostrar_contancias_canon_correccion="
              mostrar1.constancias_canon_correccion
            "
            :desactivar_contancias_canon_correccion="
              disables1.constancias_canon_correccion
            "
            :iia="form.iia"
            ...
            :mostrar_iia="mostrar1.iia"
            :desactivar_iia="disables1.iia"
            :mostrar_iia_correccion="mostrar1.iia_correccion"
            :desactivar_iia_correccion="disables1.iia_correccion"
            :dia="form.dia"
            ...
            :mostrar_dia="mostrar1.dia"
            :desactivar_dia="disables1.dia"
            :mostrar_dia_correccion="mostrar1.dia_correccion"
            :desactivar_dia_correccion="disables1.dia_correccion"
            :acciones_a_desarrollar="form.acciones_a_desarrollar"
            :acciones_a_desarrollar_validacion="
              form.acciones_a_desarrollar_validacion
            "
            :acciones_a_desarrollar_correcto="
              form.acciones_a_desarrollar_correcto
            "
            :obs_acciones_a_desarrollar="form.obs_acciones_a_desarrollar"
            :obs_acciones_a_desarrollar_valido="
              form.obs_acciones_a_desarrollar_valido
            "
            :mostrar_acciones="mostrar1.acciones"
            :desactivar_acciones="disables1.acciones"
            :mostrar_acciones_correccion="mostrar1.acciones_correccion"
            :desactivar_acciones_correccion="
              disables1.acciones_correccion
            "
            :actividad="form.actividad"
            :actividad_a_desarrollar_validacion="
              form.actividad_a_desarrollar_validacion
            "
            :actividad_a_desarrollar_correcto="
              form.actividad_a_desarrollar_correcto
            "
            :obs_actividad_a_desarrollar="form.obs_actividad_a_desarrollar"
            :obs_actividad_a_desarrollar_valido="
              form.obs_actividad_a_desarrollar_valido
            "
            :mostrar_actividad="mostrar1.actividad"
            :desactivar_actividad="disables1.actividad"
            :mostrar_actividad_correccion="mostrar1.actividad_correccion"
            :desactivar_actividad_correccion="
              disables1.actividad_correccion
            "
            ...
            :mostrar_fecha_alta_dia="mostrar1.fecha_alta_dia"
            :desactivar_fecha_alta_dia="disables1.fecha_alta_dia"
            :mostrar_fecha_alta_dia_correccion="
              mostrar1.fecha_alta_dia_correccion
            "
            :desactivar_fecha_alta_dia_correccion="
              disables1.fecha_alta_dia_correccion
            "
            :fecha_vencimiento_dia="form.fecha_vencimiento_dia"
            :fecha_vencimiento_dia_validacion="
              form.fecha_vencimiento_dia_validacion
            "
            :fecha_vencimiento_dia_correcto="
              form.fecha_vencimiento_dia_correcto
            "
            :obs_fecha_vencimiento_dia="form.obs_fecha_vencimiento_dia"
            :obs_fecha_vencimiento_dia_valido="
              form.obs_fecha_vencimiento_dia_valido
            "
            :mostrar_fecha_vencimiento_dia="
              mostrar1.fecha_vencimiento_dia
            "
            :desactivar_fecha_vencimiento_dia="
              disables1.fecha_vencimiento_dia
            "
            :mostrar_fecha_vencimiento_dia_correccion="
              mostrar1.fecha_vencimiento_dia_correccion
            "
            :desactivar_fecha_vencimiento_dia_correccion="
              disables1.fecha_vencimiento_dia_correccion
            "
            :mostrar_boton_guardar_cinco="mostrar1.boton_guardar_cinco"
            :desactivar_boton_guardar_cinco="
              disables1.boton_guardar_cinco
            "
            :evaluacion="evaluacion_global"
            :id="form.id"
            :testing="testing_global"
          ...
          <PaginaSeisDatosUbicacionMina
            ...
            "
            :mostrar_ubicacion_prov="mostrar1.ubicacion_prov"
            :desactivar_ubicacion_prov="disables1.ubicacion_prov"
            :mostrar_ubicacion_prov_correccion="
              mostrar1.ubicacion_prov_correccion
            "
            :desactivar_ubicacion_prov_correccion="
              disables1.ubicacion_prov_correccion
            "
            ...
            "
            :mostrar_ubicacion_dpto="mostrar1.ubicacion_dpto"
            :desactivar_ubicacion_dpto="disables1.ubicacion_dpto"
            :mostrar_ubicacion_dpto_correccion="
              mostrar1.ubicacion_dpto_correccion
            "
            :desactivar_ubicacion_dpto_correccion="
              disables1.ubicacion_dpto_correccion
            "
            ...
            "
            :mostrar_ubicacion_localidad="mostrar1.ubicacion_localidad"
            :desactivar_ubicacion_localidad="
              disables1.ubicacion_localidad
            "
            :mostrar_ubicacion_localidad_correccion="
              mostrar1.ubicacion_localidad_correccion
            "
            :desactivar_ubicacion_localidad_correccion="
              disables1.ubicacion_localidad_correccion
            "
            ...
            :mostrar_ubicacion_sistema="mostrar1.ubicacion_sistema"
            :desactivar_ubicacion_sistema="disables1.ubicacion_sistema"
            :mostrar_ubicacion_sistema_correccion="
              mostrar1.ubicacion_sistema_correccion
            "
            :desactivar_ubicacion_sistema_correccion="
              disables1.ubicacion_sistema_correccion
            "
            ...
            :mostrar_ubicacion_latitud="mostrar1.ubicacion_latitud"
            :desactivar_ubicacion_latitud="disables1.ubicacion_latitud"
            :mostrar_ubicacion_latitud_correccion="
              mostrar1.ubicacion_latitud_correccion
            "
            :desactivar_ubicacion_latitud_correccion="
              disables1.ubicacion_latitud_correccion
            "
            ...
            :mostrar_ubicacion_long="mostrar1.ubicacion_long"
            :desactivar_ubicacion_long="disables1.ubicacion_long"
            :mostrar_ubicacion_long_correccion="
              mostrar1.ubicacion_long_correccion
            "
            :desactivar_ubicacion_long_correccion="
              disables1.ubicacion_long_correccion
            "
            :lista_provincias="lista_provincias"
            :lista_dptos="lista_dptos_mina"
            :mostrar_boton_guardar_seis="mostrar1.boton_guardar_seis"
            :desactivar_boton_guardar_seis="disables1.boton_guardar_seis"
            :evaluacion="evaluacion_global"
            :id="form.id"
            :testing="testing_global"
          >
          ...
          <PaginaCatamarca
            ...
            :mostrar_nombre_gestor="mostrar1.nombre_gestor"
            :desactivar_nombre_gestor="disables1.nombre_gestor"
            :mostrar_nombre_gestor_correccion="
              mostrar1.nombre_gestor_correccion
            "
            :desactivar_nombre_gestor_correccion="
              disables1.nombre_gestor_correccion
            "
            ...
            :mostrar_dni_gestor="mostrar1.dni_gestor"
            :desactivar_dni_gestor="disables1.dni_gestor"
            :mostrar_dni_gestor_correccion="
              mostrar1.dni_gestor_correccion
            "
            :desactivar_dni_gestor_correccion="
              disables1.dni_gestor_correccion
            "
            ...
            "
            :mostrar_profesion_gestor="mostrar1.profesion_gestor"
            :desactivar_profesion_gestor="disables1.profesion_gestor"
            :mostrar_profesion_gestor_correccion="
              mostrar1.profesion_gestor_correccion
            "
            :desactivar_profesion_gestor_correccion="
              disables1.profesion_gestor_correccion
            "
            ...
            "
            :mostrar_telefono_gestor="mostrar1.telefono_gestor"
            :desactivar_telefono_gestor="disables1.telefono_gestor"
            :mostrar_telefono_gestor_correccion="
              mostrar1.telefono_gestor_correccion
            "
            :desactivar_telefono_gestor_correccion="
              disables1.telefono_gestor_correccion
            "
            ...
            "
            :mostrar_notificacion_gestor="mostrar1.notificacion_gestor"
            :desactivar_notificacion_gestor="
              disables1.notificacion_gestor
            "
            :mostrar_notificacion_gestor_correccion="
              mostrar1.notificacion_gestor_correccion
            "
            :desactivar_notificacion_gestor_correccion="
              disables1.notificacion_gestor_correccion
            "
            ...
            :mostrar_email_gestor="mostrar1.email_gestor"
            :desactivar_email_gestor="disables1.email_gestor"
            :mostrar_email_gestor_correccion="
              mostrar1.email_gestor_correccion
            "
            :desactivar_email_gestor_correccion="
              disables1.email_gestor_correccion
            "
            ...
            :mostrar_dni_productor="mostrar1.dni_productor"
            :desactivar_dni_productor="disables1.dni_productor"
            :mostrar_dni_productor_correccion="
              mostrar1.dni_productor_correccion
            "
            :desactivar_dni_productor_correccion="
              disables1.dni_productor_correccion
            "
            ...
            :mostrar_foto_productor="mostrar1.foto_productor"
            :desactivar_foto_productor="disables1.foto_productor"
            :mostrar_foto_productor_correccion="
              mostrar1.foto_productor_correccion
            "
            :desactivar_foto_productor_correccion="
              disables1.foto_productor_correccion
            "
            ...
            "
            :mostrar_constancia_afip="mostrar1.constancia_afip"
            :desactivar_constancia_afip="disables1.constancia_afip"
            :mostrar_constancia_afip_correccion="
              mostrar1.constancia_afip_correccion
            "
            :desactivar_constancia_afip_correccion="
              disables1.constancia_afip_correccion
            "
            ...
            "
            :mostrar_autorizacion_gestor="mostrar1.autorizacion_gestor"
            :desactivar_autorizacion_gestor="
              disables1.autorizacion_gestor
            "
            :mostrar_autorizacion_gestor_correccion="
              mostrar1.autorizacion_gestor_correccion
            "
            :desactivar_autorizacion_gestor_correccion="
              disables1.autorizacion_gestor_correccion
            "
            :mostrar_boton_guardar_cinco="mostrar1.boton_guardar_cinco"
            :desactivar_boton_guardar_cinco="
              disables1.boton_guardar_cinco
          ...
          <div class="flex flex-wrap">
            ...
            <div class="w-full sm:w-2/2 md:w-1/2 xl:w-1/3 px-3 mb-6 md:mb-0">
              ...
              <span
                ...
                class="bg-gray-200 text-gary-600 py-1 px-3 rounded-full text-xs"
          ...
          <div class="flex flex-col">
            ...
            <div class="w-full sm:w-2/2 md:w-1/2 px-3 mb-6 md:mb-0">
              <button
                ...
                :disabled="disables1.boton_actualizar"
                class="
                  text-white
                  uppercase
                  text-lg
...
export default {
  ...
  data() {
    ...
    return {
      mostrar1: provincias[this.$props.nombre_provincia].mostrar,
      disables1: provincias[this.$props.nombre_provincia].disables,
      ...
      form: {
        ...
        numeroproductor_correcto:
          this.$props.productor.numeroproductor_correcto,
        ...
        constaciasociedad_correcto:
          this.$props.productor.constanciasociedad_correcto,
        ...
        leal_departamento_correcto:
          this.$props.productor.leal_departamento_correcto,
        ...
        administracion_provincia:
          this.$props.productor.administracion_provincia,
        ...
        administracion_departamento:
          this.$props.productor.administracion_departamento,
        ...
        administracion_localidad:
          this.$props.productor.administracion_localidad,
        ...
        numero_expdiente_correcto:
          this.$props.productor.numero_expdiente_correcto,
        ...
        descripcion_mina_correcto:
          this.$props.productor.descripcion_mina_correcto,
        ...
        distrito_minero_correcto:
          this.$props.productor.distrito_minero_correcto,
        ...
        sustancias_correcto:
          this.$props.productor.sustancias_de_aprovechamiento_comun_correcto,
        obs_sustancias:
          this.$props.productor.obs_sustancias_de_aprovechamiento_comun,
        ...
        titulo_contrato_posecion:
          this.$props.productor.titulo_contrato_posecion,
        ...
        resolucion_concesion_minera:
          this.$props.productor.resolucion_concesion_minera,
        ...
        obs_acciones_a_desarrollar_valido:
          this.$props.productor.concesion_minera_aclaracion,
        ...
        localidad_mina_provincia:
          this.$props.productor.localidad_mina_provincia,
        ...
        localidad_mina_departamento:
          this.$props.productor.localidad_mina_departamento,
        ...
        localidad_mina_localidad:
          this.$props.productor.localidad_mina_localidad,
      ...
      form_particular: {
        ...
        gestor_nombre_apellido:
          this.$props.productor_particular.gestor_nombre_apellido,
        gestor_nombre_apellido_valido: true,
        gestor_nombre_apellido_correcto:
          this.$props.productor_particular.gestor_nombre_apellido,
        obs_gestor_nombre_apellido:
          this.$props.productor_particular.obs_gestor_nombre_apellido,
        ...
        gestor_profesion_correcto:
          this.$props.productor_particular.gestor_profesion,
        obs_gestor_profesion:
          this.$props.productor_particular.obs_gestor_profesion,
        ...
        gestor_telefono_correcto:
          this.$props.productor_particular.gestor_telefono,
        obs_gestor_telefono:
          this.$props.productor_particular.obs_gestor_telefono,
        obs_gestor_telefono_valido: true,

        gestor_notificacion:
          this.$props.productor_particular.gestor_notificacion,
        gestor_notificacion_valido: true,
        gestor_notificacion_correcto:
          this.$props.productor_particular.gestor_notificacion,
        obs_gestor_notificacion:
          this.$props.productor_particular.obs_gestor_notificacion,
        ...
        segunda_hoja_dni_correcto:
          this.$props.productor_particular.hoja_dni_correcto,
        ...
        constancia_afip_correcto:
          this.$props.productor_particular.constancia_afip_correcto,
        obs_constancia_afip:
          this.$props.productor_particular.obs_constancia_afip,
        obs_constancia_afip_valido: true,

        autorizacion_gestor:
          this.$props.productor_particular.autorizacion_gestor,
        autorizacion_gestor_valido: true,
        autorizacion_gestor_correcto:
          this.$props.productor_particular.autorizacion_gestor_correcto,
        obs_autorizacion_gestor:
          this.$props.productor_particular.obs_autorizacion_gestor,
  ...
  mounted() {
    console.log(this.$props.nombre_provincia);
    // this.prueba = provincias[this.$props.nombre_provincia];
    console.log("***********************************************");
    console.log("MOSTRAR");
    console.log("***********************************************");
    ...
    submit() {
      ...
      if (typeof this.form.id !== "undefined" && self.form.id != null) {
        ...
        this.modal_body_apro =
          "Usted debe guardar el paso 1 antes de presentar el formulario";
