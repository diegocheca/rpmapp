<template>
  <div>
    ...
    >
        ...
        <div class="mt-2">
          <label class="inline-flex items-center">
            <input
              ...
              :name="name_correcto"
              v-model="legal_calle_tel_correcto_local"
              value="true"
              v-on:change="actaulizar_variable_legalcalletel(true)"
            />
          ...
          <label class="inline-flex items-center ml-6">
            <input
              ...
              v-model="legal_calle_tel_correcto_local"
              value="false"
              v-on:change="actaulizar_variable_legalcalletel(false)"
            />
          ...
          <label class="inline-flex items-center ml-6">
            <input
              ...
              v-model="legal_calle_tel_correcto_local"
              value="nada"
              v-on:change="actaulizar_variable_legalcalletel('nada')"
            />
      ...
      <div
        v-show="!legal_calle_tel_correcto_local"
      ...
      >
        ...
        <textarea
          ...
          @input="
            actaulizar_contenido_text_area_calle_legal_tel($event.target.value)
          "
        >
        </textarea>
        <p v-bind:class="clase_cartel_nota_evaluacion_tel_calle">
    ...
    >
      ...
      <div class="flex">
        <div v-show="testing_hijo">
          -- telefono calle:{{ leal_telefono }}-- --telefono calle Valido:{{
            leal_telefono_valido
          }}-- --telefono calle Valido local:{{
            calle_tel_legal_valido_local
          }}-- --telefono calle Evalaucion:{{ leal_telefono_correcto }}--
          --telefono calle Obser:{{ obs_leal_telefono }}-- --telefono calle obsr
          Valido:{{ obs_leal_telefono_valido }}-- --Evaluacion
          {{ evaluacion }}-- --{{ cartel_nota_evaluacion_tel_calle }}--
        </div>
      </div>
    </div>
  </div>
