...
export default {
  ...
  data() {
    return {
        clase_de_input_calle_tel_legal: 'appearance-none block w-full bg-gray-200 text-gray-700 border rounded py-3 px-4 mb-1 leading-tight focus:outline-none focus:bg-white',
        cartel_nota_legalcalletel: '',
        clase_cartel_nota_legalcalletel: 'text-green-500 text-xs italic',
        clase_text_area_calle_legal_tel: 'appearance-none block w-full bg-gray-200 text-gray-700 border rounded py-3 px-4 mb-1 leading-tight focus:outline-none focus:bg-white',
  ...
  methods:{
    actaulizar_variable_legalcalletel(valor) {
      ...
      actaulizar_contenido_text_area_calle_legal_tel(value) {
        ...
        {
            this.clase_text_area_calle_legal_tel=  'appearance-none block w-full bg-gray-200 text-gray-700 border border-red-500 rounded py-3 px-4 mb-1 leading-tight focus:outline-none focus:bg-white';
        ...
        {
            this.clase_text_area_calle_legal_tel=  'appearance-none block w-full bg-gray-200 text-gray-700 border border-green-500 rounded py-3 px-4 mb-1 leading-tight focus:outline-none focus:bg-white';
    ...
    cambio_input_calle_tel_legal(){
        ...
        {
            this.clase_de_input_calle_tel_legal= 'appearance-none block w-full bg-gray-200 text-gray-700 border-red-500 border rounded py-3 px-4 mb-1 leading-tight focus:outline-none focus:bg-white';
        ...
        {
            this.clase_de_input_calle_tel_legal =  'appearance-none block w-full bg-gray-200 text-gray-700 border border-red-500 rounded py-3 px-4 mb-1 leading-tight focus:outline-none focus:bg-white';
        ...
        {
            this.clase_de_input_calle_tel_legal=  'appearance-none block w-full bg-gray-200 text-gray-700 border border-green-500 rounded py-3 px-4 mb-1 leading-tight focus:outline-none focus:bg-white';
