                    ...
                    >
                        <div class="flex flex-col">
                            ...
                            <div
                                ...
                                "
                                :class="[
                                    values[item.observation.options[0].name] !=
                                    'rechazado'
                                        ? 'bg-blue-200'
                                        : 'bg-red-200',
                                ]"
                            ...
                            >
                                <div class="w-full flex flex-wrap">
                                    ...
                                    <!-- inputs radio -->
                                    <div
                                        v-for="(obs, index) in item.observation
                                            .options"
                                        :key="index"
                                    >
                                        <label>
                                ...
                                <div
                                    v-show="
                                        values[
                                            item.observation.options[0].name
                                        ] == 'rechazado'
                                    "
                                    class="
                                        w-full
                                ...
                                >
                                    <label
                                        ...
                                        "
                                        >{{
                                            item.observation.comment.label
                                        }}
                                        :</label
                                    >
                                    <Field
...
export default {
    ...
    methods: {
        ...
        getSelectOptions(value, element) {
            ...
            for (let index = 0; index < elementChange.length; index++) {
                ...
                for (let index = 0; index < options.length; index++) {
                    ...
                    this.$refs[`${element.id}-${elementDepends}`].options.push(
                        opt
                    );
                }
            }
        ...
        async getAsyncOptionsSelect(value, element) {
            ...
            if (
                !element ||
                !element.inputDepends ||
                element.inputDepends.length == 0
            )
                return;
