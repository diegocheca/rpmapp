			...
			<div class="w-full bg-white rounded shadow-lg p-8 m-4">
				...
				<form @submit.prevent="submit" class="mb-8">
					<div class="flex h-screen bg-gray-200 items-center justify-center  mt-32 mb-32">
						<div class="grid bg-white rounded-lg shadow-xl w-11/12 md:w-9/12 lg:w-2/2">
							...
							<div class="flex">
								<h1 class="text-gray-600 font-bold md:text-2xl text-xl">Editando una Relacion entre mina y Productor</h1>
							</div>
							</div>
	...
	data() {
		return {
			...
			form: {
				...
				administracion_calle: this.$props.productorMina.id,
