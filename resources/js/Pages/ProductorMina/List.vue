  ...
  <app-layout>
    <h2
      ...
      <div class="w-11/12 flex flex-row-reverse mt-3">
        <inertia-link
          :href="route('productores_minas.create')"
      ...
      >
        ...
        <div
          v-if="productores_minas.data.length == 0"
        ...
        >
          ...
          <p class="text-2xl">No se han registrado Productores/minas</p>
        </div>
        <div v-if="productores_minas.data.length > 0" class="w-full lg:w-5/6">
          <div class="bg-white shadow-md rounded my-6">
            <table class="min-w-max w-full table-auto">
              <thead>
                ...
                >
                  ...
                  <th class="py-3 px-6 text-center">Mina</th>
                  <th class="py-3 px-6 text-center">Num Exp</th>
              ...
              <tbody class="text-gray-600 text-sm font-light">
                <tr
                  v-for="(prod_min, index) in productores_minas.data"
                  :key="prod_min.id"
                  :class="{ 'bg-gray-100': index % 2 === 0 }"
                >
                  <td class="py-3 px-6 text-left">
                    <div class="flex items-center">
                      <span class="font-medium">{{ prod_min.id }}</span>
                    </div>
                  </td>
                  <td class="py-3 px-6 text-left">
                    <div class="flex items-center justify-center">
                        <inertia-link
                          :href="route('productores.edit', prod_min.id_productor)"
                        >
                          {{ prod_min.razonsocial}}
                        </inertia-link>
                    </div>
                  </td>
                  <td class="py-3 px-6 text-center">
                    <div class="flex items-center justify-center">
                      <inertia-link
                          :href="route('productores.edit', prod_min.id_mina)"
                        >
                          {{ prod_min.nombre}}
                        </inertia-link>
                    </div>
                  ...
                  <td class="py-3 px-6 text-center">
                    <div class="flex items-center justify-center">
                      {{ prod_min.num_expediente_SIGETRAMI }}
                    </div>
                  ...
                  <td class="py-3 px-6 text-center">
                    <div class="flex item-center justify-center">
                      ...
                      >
                        <inertia-link
                          :href="route('productores_minas.edit', prod_min.id)"
                        >
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                            fill="none"
                      ...
                      >
                        <inertia-link
                          :href="route('productores_minas.destroy', prod_min.id)"
                        >
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                            fill="none"
            ...
            <pagination class="mt-6" :links="productores_minas.links" />
          </div>
        ...
        >
          <div class="w-full lg:w-5/6">
            ...
            <table class="min-w-max w-full table-auto">
              ...
              <tbody class="text-gray-600 text-sm font-light">
                <tr v-for="productor_mina in borradores.data" :key="productor_mina.id" :class="{ 'bg-gray-100': index % 2 === 0 }">
                  <td class="py-3 px-6 text-left">
                    <div class="flex items-center">
                      <span class="font-medium">{{ productor_mina.id }}</span>
                    </div>
                  </td>
                  <td class="py-3 px-6 text-left">
                    <div class="flex items-center">
                      <span class="font-medium">{{ productor_mina.id_productor }}</span>
                    </div>
                  </td>
                  <td class="py-3 px-6 text-left">
                    <div class="flex items-center">
                      <span class="font-medium">{{ productor_mina.id_mina }}</span>
                    </div>
                  </td>
                  ...
                  <td class="px-6 py-4 whitespace-nowrap">
                    <div class="text-sm text-gray-900">{{ productor_mina.estado }}</div>
                  </td>
                  <td
                    class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium"
                  >
                  <div class=" w-4 mr-2 transform hover:text-purple-500 hover:scale-110" >
                  <a @click="mostrarInfo(productor_mina.id)">
                  ...
                  <div class=" w-4 mr-2 transform hover:text-purple-500 hover:scale-110" >
                    <a @click="mostrarInfoMinerales(productor_mina.id)">
            ...
            <pagination class="mt-6" :links="borradores.links" />
              ...
              <jet-dialog-modal :show="mostrarModalMineral" @close="closeModal">
                <template #title>
                  {{ modal_tittle }}
                </template>
                <template #content>
...
export default {
  ...
  methods: {
    ...
    mostrarInfo(id) {
      //buscar los datos en el backend sin recargar datos
      this.mostrarModal = true;
      this.modal_tittle = "Datos de la Mina y Productor";
      this.modal_body = "los datos son::::"+id;

      this.id_a_eliminar = id;
    },
    mostrarInfoMinerales(id) {
      //buscar los datos en el backend sin recargar datos
      // para mostrar la lista de minerales
      this.mostrarModal = true;
      this.modal_tittle = "Datos sdasdasdde la Mina y Productor";
      this.modal_body = "los datos son::::"+id;
    ...
    closeModal() {
      ...
      this.mostrarModalMineral = false;
