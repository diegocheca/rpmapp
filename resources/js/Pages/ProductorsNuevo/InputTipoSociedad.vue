    ...
    >
        ...
        <div class="mt-2">
          <label class="inline-flex items-center">
            <input
              ...
              name="name_tiposociedad_correcto"
              v-model="tiposociedad_correcto"
              value="true"
              v-on:change="actaulizar_variable_tiposociedad(true)"
            />
          ...
          <label class="inline-flex items-center ml-6">
            <input
              ...
              v-model="tiposociedad_correcto"
              value="false"
              v-on:change="actaulizar_variable_tiposociedad(false)"
            />
          ...
          <label class="inline-flex items-center ml-6">
            <input
              ...
              v-model="tiposociedad_correcto"
              value="nada"
              v-on:change="actaulizar_variable_tiposociedad('nada')"
            />
      ...
      <div v-show="!tiposociedad_correcto_local" class="w-full md:w-2/3 px-3">
        ...
        <textarea
          ...
          :disabled="$props.tipo_sociedad_correccion_desactivar"
          @input="
            actaulizar_contenido_text_area_tiposociedad($event.target.value)
          "
        >
        </textarea>
        <p v-bind:class="clase_cartel_nota_evaluacion_tiposociedad_text_area">
          {{ cartel_nota_evaluacion_tiposociedad_text_area }}
        </p>
      </div> -->
      <SeccionEvaluacion
