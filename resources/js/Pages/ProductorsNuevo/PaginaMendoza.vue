        ...
        <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
          <NombreMina
            ...
            v-bind:mostrar_correccion="
              permisos_mostrar.situacion_mina_correccion
            "
            v-bind:desactivar_correccion="
        ...
        <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
          <NombreMina
            ...
            v-bind:valor_input_validacion="
              form_mendoza.concesion_minera_asiento_n_valido
            "
            ...
            v-bind:desactivar_input="
              permisos_disables.concesion_minera_asiento_n
            "
      ...
      <div class="flex flex-wrap">
        <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
          <NombreMina
            ...
            v-bind:valor_input_validacion="
              form_mendoza.concesion_minera_reg_cant_valido
            "
            v-bind:evualacion_correcto="false"
            v-bind:valor_obs="false"
            v-bind:valor_valido_obs="false"
            ...
            v-bind:icon="$inertia.page.props.appName + '/svg/state.svg'"
            v-bind:desactivar_input="
              permisos_disables.concesion_minera_reg_cant
            "
            v-bind:mostrar_correccion="false"
            v-bind:desactivar_correccion="false"
        ...
        <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
          <NombreMina
            ...
            v-bind:valor_input_validacion="
              form_mendoza.concesion_minera_reg_m_y_d_valido
            "
            v-bind:evualacion_correcto="false"
            v-bind:valor_obs="false"
            v-bind:valor_valido_obs="false"
            ...
            v-bind:icon="$inertia.page.props.appName + '/svg/state.svg'"
            v-bind:desactivar_input="
              permisos_disables.concesion_minera_reg_m_y_d
            "
            v-bind:mostrar_correccion="false"
            v-bind:desactivar_correccion="false"
            v-on:changeobsvalido="
