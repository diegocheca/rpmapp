          ...
          <div class="bg-white rounded-2xl dark:bg-gray-700">
            ...
            >
              ...
              >
                ...
                <img
                  class="relative w-40"
                  src="http://localhost:8000/minerales/thumbs/1171.png"
                  alt=""
                />
              </div>
              <div class="relative text-white px-6 pb-6 mt-6">
                <span class="block opacity-75 -mb-1"
                  >Mineral más Producido</span
                >
            ...
            >
              ...
              >
                ...
                <img
                  class="relative w-40"
                  src="http://localhost:8000/minerales/thumbs/1132.png"
                  alt=""
                />
              </div>
              <div class="relative text-gray px-6 pb-6 mt-6">
                <span class="block opacity-75 -mb-1"
                  >2° Mineral más Producido</span
                >
                <div class="flex justify-between">
            ...
            >
              ...
              >
                ...
                <img
                  class="relative w-40"
                  src="http://localhost:8000/minerales/thumbs/1104.png"
                  alt=""
                />
              </div>
              <div class="relative text-gray px-6 pb-6 mt-6">
                <span class="block opacity-75 -mb-1"
                  >3° Mineral más vendido</span
                >
                <div class="flex justify-between">
        ...
        <div class="flex flex-col w-full pl-0 md:p-4 md:space-y-4">
          ...
          >
            <div class="flex p-6 sm:px-20 bg-white border-b border-gray-200">
              ...
              <div class="flex-auto">
                <h1>Bienvenido a RPM!</h1>
                <br />
                El sistema informático para el registro de productores mineros
                (RPM), es un sistema diseñado para la administración de los
                datos relacionados a los productores mineros y sus
                reinscripciones.
              </div>
            </div>
          </header>
          ...
          <div class="pb-24 pt-2 pr-2 pl-2 md:pt-0 md:pr-0 md:pl-0">
            <div class="flex flex-col flex-wrap sm:flex-row">
                      ...
                      <a href="#" class="">
                        <img
                          class="
                            ...
                            ring-2 ring-white
                          "
                          src="http://localhost:8000/storage/profile-photos/eYIUn5nN4rFHDsjnHqmsvg1XUoZAOi6ijrKQYq0W.png"
                          alt="Guy"
                        />
                      </a>
                    </div>
                      ...
                      <a href="#" class="">
                        <img
                          class="
                            ...
                            ring-2 ring-white
                          "
                          src="http://localhost:8000/storage/profile-photos/xrQp3HSR1OOcnFIveCX6ZdVFH2gwCZ7PZxLP5G1E.jpg"
                          alt="Guy"
                        />
                      </a>
                    </div>
                    ...
                    <ul>
                      ...
                      >
                        <div class="flex items-center justify-start text-sm">
                          ...
                          <span> Mina Primer Categoria </span>
                        </div>
                        <svg
                          width="20"
                          height="20"
                      ...
                      >
                        <div class="flex items-center justify-start text-sm">
                          ...
                          <span> Mina Segunda Categoria </span>
                        </div>
                        <svg
                          width="20"
                          height="20"
                      ...
                      >
                        <div class="flex items-center justify-start text-sm">
                          ...
                          <span> Cantera de Tercer Categoria </span>
                        </div>
                        <svg
                          width="20"
                          height="20"
              ...
              <div class="w-full sm:w-1/2 xl:w-5/12">
                <div class="mb-4">
                  <div
                    class="shadow-lg rounded-2xl p-4 bg-white dark:bg-gray-700"
                  >
                      ...
                      <div class="w-full rounded shadow-sm">
                        ...
                        <div class="-mx-2">
                          <table class="w-full dark:text-white">
                            <tr>
                              <th class="py-3 px-2 md:px-3">D</th>
                              <th class="py-3 px-2 md:px-3">L</th>
                              <th class="py-3 px-2 md:px-3">M</th>
                              <th class="py-3 px-2 md:px-3">M</th>
                              <th class="py-3 px-2 md:px-3">J</th>
                              <th class="py-3 px-2 md:px-3">V</th>
            ...
            <div class="flex items-center bg-gray-200 text-gray-800">
              <div class="w-full flex px-3">
                ...
                >
                  <div
                    style="
                      background: url('http://localhost:8000/minerales/Molibden.png');
                    "
                    class="
                      h-52
                      sm:h-full
              ...
              <div class="w-full flex px-3">
                ...
                >
                  <div
                    style="
                      background: url('http://localhost:8000/minerales/thumbs/1175.png');
                    "
                    class="
                      h-52
                      sm:h-full
                    ...
                    <div class="flex align-items-center">
                      ...
                      <div class="ml-3">
                        ...
                        <div class="text-gray-500">
                          minas_argentinas@rgmail.com
                        </div>
                      </div>
                    </div>
                  </td>
                  <td class="p-3">Oro y Plata</td>
                  <td class="p-3 font-bold">200.00$ / tonelada</td>
                  <td class="p-3">
