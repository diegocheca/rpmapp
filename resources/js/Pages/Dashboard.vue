<template>
    ...
    <div class="flex items-start justify-between">
        ...
        <div class="flex flex-col w-full pl-0 md:p-4 md:space-y-4">
            <header class="w-full shadow-lg bg-white dark:bg-gray-700 items-center rounded-2xl z-40">
                <div class=" flex p-6 sm:px-20 bg-white border-b border-gray-200">
                    ...
                    <div class="flex-auto">
                        ...
                        <br>
                        El sistema informático para el registro de productores mineros (RPM), es un sistema diseñado para la administración de los datos relacionados a los productores mineros y sus reinscripciones.
                    </div>
                </div>
            </header>
