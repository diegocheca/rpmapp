                        ...
                        <div class="flex">
                            ...
                            >
                                ...
                                <jet-nav-link
                                    ...
                                    :active="
                                        route().current('formulario-alta.index')
                                    "
                                >
                                    Borradores
                                </jet-nav-link>
                                ...
                                <jet-nav-link
                                    ...
                                    :active="
                                        route().current('reinscripciones.index')
                                    "
                                >
                                    Reinscripciones
                                </jet-nav-link>
                                ...
                                <jet-nav-link
                                    ...
                                    :active="
                                        route().current('productores.index')
                                    "
                                >
                                    Productores
                                </jet-nav-link>
                                ...
                                <jet-nav-link
                                    ...
                                    :active="
                                        route().current('solicitudes.index')
                                    "
                                >
                                    Formularios WEB
                                </jet-nav-link>
                ...
                <!-- Hamburger -->
                        ...
                        <div >
                            ...
                            <transition name="slide-fade">
                                ...
                                <!-- Page content -->
                                <button  @click="isSidebarOpen = true" class="animate-pulse fixed p-2 text-white bg-black rounded-lg top-5 left-5">
                                    <svg
                                    class="w-6 h-6"
                                    xmlns="http://www.w3.org/2000/svg"
                                    fill="none"
