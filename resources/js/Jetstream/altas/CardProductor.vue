	...
	<div :class="clase_sup">
		<div :class="clase_inf">
			<a href="#section_productor">
				<img class="animate-bounce w-20 h-20 object-cover rounded-full border-2 border-indigo-500" :src="$inertia.page.props.appName+'/slick/img/features/casco-minero.svg'" width="50%">
			</a>
			<div class="mt-8">
				<p class="text-xl font-semibold my-2">Datos del Producto</p>
