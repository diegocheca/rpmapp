...
<section class="error">
  ...
  <div class="error__content">
    <div class="error__message message">
      <h1 class="message__title">Codigo Incorrecto</h1>
      <p class="message__text">El código con el que estas intentando acceder es incorrecto. Por favor, comuniquese con el administrador.</p>
    </div>
    <div class="error__nav e-nav">
      <a href="{{url('home')}}" target="_blanck" class="e-nav__link"></a>
    </div>
  </div>
  <!-- END Content -->
