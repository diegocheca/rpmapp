...
<head>
    <!-- <title>Formulario de Alta de Productor Minero de San Juan</title> -->
     ...
     <meta charset="UTF-8">
    <title>TABLA DE PRODUCTOS COMERCIANTES</title>
...
<!-- <span>Minerales</span> -->
    <table class="table table-bordered">
       <tbody>
            <tr>
                <td style="font-size:10px;">4. &nbsp;&nbsp; MINERALES QUE COMERCIALIZA</td>
            </tr>
        </tbody>
    </table>
    ...
    <table class="table table-bordered">
      <tbody>
           <tr>
               <td style="font-size:10px;">4. &nbsp;&nbsp; DOCUMENTACIÓN ADJUNTA</td>
           </tr>
       </tbody>
   </table>
   <table class="table ">
      <tbody>
        <tr>
          <td style="border-bottom: 0px solid rgb(255, 255, 255);border-top: 0px solid rgb(255, 255, 255);padding: 0px 0px 0px 0px !important; margin: 0px 0px 0px 0px !important;"><p style="font-size:10px;"> Nombre de los documentos adjuntos</p></td>
        </tr>
      </tbody>
    </table>
    <br>
