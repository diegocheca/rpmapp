...
class FormAltaProductorEvalSalta extends Model
{
    ...
    public function crear_nuevo_salta_evaluacion($formulario_salta){
        ...
        if($formulario_salta["correccion_representante_legal_dni"] == 'nada'){
            $formulario_salta["correccion_representante_legal_dni"] = null;
        }
        if($formulario_salta["correccion_representante_legal_email"] == 'nada'){
            $formulario_salta["correccion_representante_legal_email"] = null;
        }
        if($formulario_salta["correccion_representante_legal_cargo"] == 'nada'){
            $formulario_salta["correccion_representante_legal_cargo"] = null;
        }
        if($formulario_salta["correccion_representante_legal_domicilio"] == 'nada'){
            $formulario_salta["correccion_representante_legal_domicilio"] = null;
        }
        if($formulario_salta["correccion_nacionalidad"] == 'nada'){
            $formulario_salta["correccion_nacionalidad"] = null;
        }
        if($formulario_salta["correccion_telefono"] == 'nada'){
            $formulario_salta["correccion_telefono"] = null;
        }
        if($formulario_salta["correccion_superficie_mina"] == 'nada'){
            $formulario_salta["correccion_superficie_mina"] = null;
        }
        if($formulario_salta["correccion_volumenes_de_extraccion_periodo_anterior"] == 'nada'){
            $formulario_salta["correccion_volumenes_de_extraccion_periodo_anterior"] = null;
        }
        if($formulario_salta["correccion_n_resolucion_iia"] == 'nada'){
            $formulario_salta["correccion_n_resolucion_iia"] = null;
        }
        if($formulario_salta["correccion_etapa_de_exploracion"] == 'nada'){
            $formulario_salta["correccion_etapa_de_exploracion"] = null;
        }
        if($formulario_salta["correccion_n_resolucion_aprobacion_informe"] == 'nada'){
            $formulario_salta["correccion_n_resolucion_aprobacion_informe"] = null;
        }
        if($formulario_salta["correccion_etapa_de_exploracion_avanzada"] == 'nada'){
            $formulario_salta["correccion_etapa_de_exploracion_avanzada"] = null;
        }
        if($formulario_salta["correccion_volumenes_anuales_de_materias_primas"] == 'nada'){
            $formulario_salta["correccion_volumenes_anuales_de_materias_primas"] = null;
        }
        if($formulario_salta["correccion_material_obtenido"] == 'nada'){
            $formulario_salta["correccion_material_obtenido"] = null;
        }
        if($formulario_salta["correccion_autorizacion_extractivas_exploratorias"] == 'nada'){
            $formulario_salta["correccion_autorizacion_extractivas_exploratorias"] = null;
        }
        if($formulario_salta["correccion_responsable_nombre"] == 'nada'){
            $formulario_salta["correccion_responsable_nombre"] = null;
        }
        if($formulario_salta["correccion_responsable_apellido"] == 'nada'){
            $formulario_salta["correccion_responsable_apellido"] = null;
        }
        if($formulario_salta["correccion_responsable_dni"] == 'nada'){
            $formulario_salta["correccion_responsable_dni"] = null;
        }
        if($formulario_salta["correccion_responsable_titulo"] == 'nada'){
            $formulario_salta["correccion_responsable_titulo"] = null;
        }
        if($formulario_salta["correccion_responsable_matricula"] == 'nada'){
            $formulario_salta["correccion_responsable_matricula"] = null;
        }
        if($formulario_salta["correccion_ley_24196_numero"] == 'nada'){
            $formulario_salta["correccion_ley_24196_numero"] = null;
        }
        if($formulario_salta["correccion_ley_24196_inscripcion_renar"] == 'nada'){
            $formulario_salta["correccion_ley_24196_inscripcion_renar"] = null;
        }
        if($formulario_salta["correccion_ley_24196_explosivos"] == 'nada'){
            $formulario_salta["correccion_ley_24196_explosivos"] = null;
        }
        if($formulario_salta["correccion_ley_24196_propiedad"] == 'nada'){
            $formulario_salta["correccion_ley_24196_propiedad"] = null;
        }
        if($formulario_salta["correccion_estado_contable"] == 'nada'){
            $formulario_salta["correccion_estado_contable"] = null;
        }
        if($formulario_salta["correccion_listado_de_maquinaria"] == 'nada'){
            $formulario_salta["correccion_listado_de_maquinaria"] = null;
        }
        if($formulario_salta["correccion_regalias"] == 'nada'){
            $formulario_salta["correccion_regalias"] = null;
        }
        if($formulario_salta["correccion_personas_afectadas"] == 'nada'){
            $formulario_salta["correccion_personas_afectadas"] = null;
        }
        if($formulario_salta["correccion_multas"] == 'nada'){
