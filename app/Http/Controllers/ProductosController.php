...
class ProductosController extends Controller
{
    ...
    public function show($id_producto)
    {
		...
		if ($entro) {
            ...
            $mina = MinaCantera::find($producto->id_mina);
    ...
    public function actualizar(Request $request)
    {
        ...
        $producto->variedad = $request->form["variedad"];
        $producto->produccion = $request->form["produccion"];
        $producto->unidades = $request->form["unidades"];
        //$producto->otra_unidad = $request->otra_unidad;
