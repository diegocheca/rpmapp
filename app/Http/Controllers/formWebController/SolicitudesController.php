...
public function create()
   {
        ...
        return Inertia::render('formWeb/Form', [
            ...
            'folder' => 'solicitudes',
            'reinscripcion' => [],
            'titleForm' => 'Crear Permiso de Exploración',
            'evaluate' => false,
            'provincia' => $provinces,            
...
public function create2()
    { 
        ...
        return Inertia::render('formWeb/Form2', [
            ...
            'titleForm' => 'Crear Manifestación de Descubrimeinto',
            'provincia' => $provincia,
...
//procesa_datos_de_permiso_solicitud_exploracion
    ...
    {        
        ...
        switch ($Step) {
            ...
            case 1: //DATOS SOLICITUD 
                ...
                $tipo = 'Permiso de Exploracion';
                $nom_sub_est = "b1"; //b1 = borrador 1 -Datos de Solicitud-               
            ...
            case 2: //DATOS SOLICITANTE              
                ...
                $solicitud_id = formSolicitud::all()->last()->id; 

                $nom_sub_est = "b2"; //b2 = borrador 2 -Datos de Solicitante-
                $date = Carbon::now();
                formSolicitud::where('id',$solicitud_id)->update(['sub_estado'=>$nom_sub_est]);                
            ...
            case 3: //DATOS REPRESENTANTE LEGAL               
                ...
                //recupero id de la solicitud que se acaba de crear
                $solicitud_id = formSolicitud::all()->last()->id;                                     
                $nom_sub_est = "b3"; //b3 = borrador 3 -Datos de Representante Legal-
                $date = Carbon::now();
                formSolicitud::where('id',$solicitud_id)->update(['sub_estado'=>$nom_sub_est]); 
                break;
            ...
            case 4: //DATOS TERRENO-CATEGORIA-MATRICULA CATASTRAL Y COORDENADAS                                                               
                ...
                $nom_sub_est = "b4"; //b4 = borrador 4 -Datos Terreno-MC-Cordenadas-
                $date = Carbon::now();
                formSolicitud::where('id',$solicitud_id)->update(['sub_estado'=>$nom_sub_est]); 
            ...
            case 5: //DATOS PROPIETARIO   
                ...
                //recupero id de la solicitud que se acaba de crear 
                $solicitud_id = formSolicitud::all()->last()->id; 
                $nom_sub_est = "b5"; //b5 = borrador 5 -Datos Propietario
                $date = Carbon::now();
                formSolicitud::where('id',$solicitud_id)->update(['sub_estado'=>$nom_sub_est]);                                 
        ...
        $date = Carbon::now(); //obtengo la fecha actual
        $solicitud = formSolicitud::all()->last()->id;
        $sub_e = formSolicitud::find($solicitud);
      
        if($sub_e->sub_estado == "b5"){
            $estado = "Enviada";
        }else{
            $estado = "Borrador";
        }
        formSolicitud::where('id',$solicitud)->update(['estado'=>$estado, 'fecha_estado'=>$date]);                                 
        return response()->json('ok');
    }

//procesa_datos_de_manifestacion_descubrimiento
public function procesa(Request $request)
     {
         ...
         switch ($Step2) {
             case 1: //DATOS SOLICITUD DESCUBRIMIENTO   
                 ...
                 $tipoSoli = 'Manifestación de Descubrimiento';
...
public function show2(){
    return Inertia::render('formWeb/sol_borrador');
}
